...
const apiCallsMapping = (action) => {
    const mapping = {
        ...
        [repositoryPageActions.GET_REPOSITORY_ADDITIONAL_INFO_REQUEST]: repositoryPageApi.getRepositoryAdditionalInfo,

        [repositoryPageActions.GET_REPOSITORY_LANGUAGES_INFO_REQUEST]: repositoryPageApi.getRepositoryLanguagesInfo
